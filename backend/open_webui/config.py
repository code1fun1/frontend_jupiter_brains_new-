...
AUTO_MODEL_SELECTION_ENABLED = os.environ.get(
    "AUTO_MODEL_SELECTION_ENABLED", "true"
).lower() == "true"
DEFAULT_AUTO_SELECT = os.environ.get("DEFAULT_AUTO_SELECT", "false").lower() == "true"
...
REPLICATE_API_KEY = PersistentConfig(
    "REPLICATE_API_KEY",
    "video_generation.replicate_api_key",
    os.environ.get("REPLICATE_API_KEY", "")
)
VIDEO_GENERATION_MODEL = PersistentConfig(
    "VIDEO_GENERATION_MODEL",
    "video_generation.model",
    os.environ.get("VIDEO_GENERATION_MODEL", "minimax/video-01")
)
